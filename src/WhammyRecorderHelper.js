var Whammy = require('./Whammy.js');
var utils = require('./utils.js');

module.exports = function WhammyRecorderHelper(mediaStream, root) {
    ...
    this.requestData = function() {
        ...
        console.debug('video recorded blob size:', utils.bytesToSize(WebM_Blob.size));
